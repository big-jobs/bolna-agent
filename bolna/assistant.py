...
class Assistant:
    ...
    def add_task(self, task_type, llm_agent, input_queue=None, output_queue=None, transcriber=None, synthesizer=None,
                 enable_textual_input=False):
        pipelines = []
        toolchain_args = {'execution': 'parallel', 'pipelines': pipelines}
        tools_config_args = {
            'llm_agent': llm_agent, 'input': {
                "format": "wav",
                "provider": "default"
            }, 'output': {
                "format": "wav",
